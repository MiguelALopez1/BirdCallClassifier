...
train_dl = torch.load('train_dl.pth')
val_dl = torch.load('val_dl.pth')
...
num_epochs = 2
epoch_losses, epoch_accuracies = training(myModel, train_dl, num_epochs)
...
plt.subplot(1, 2, 2)
plt.plot(range(num_epochs), epoch_accuracies, label='Accuracy')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
